...
(function () {
    ...
    var horizontalMenuSplit = 11; // after this number all horizontal menus will be moved in More menu options
    var default_lang = "en"; // set Default Language
    var language = localStorage.getItem("language");

    if (document.documentElement.clientWidth >= 1025 && document.documentElement.clientWidth < 1180)
        horizontalMenuSplit = 5;
    else if (document.documentElement.clientWidth >= 1180 && document.documentElement.clientWidth < 1350)
        horizontalMenuSplit = 6;
    else if (document.documentElement.clientWidth >=1350 && document.documentElement.clientWidth < 1550)
        horizontalMenuSplit = 7;
    else if (document.documentElement.clientWidth >= 1550 && document.documentElement.clientWidth < 1750)
        horizontalMenuSplit = 8;
    else if (document.documentElement.clientWidth >= 1750 && document.documentElement.clientWidth < 1800)
        horizontalMenuSplit = 9;
    else
        horizontalMenuSplit = 11
