USE [master]
GO
/****** Object:  Database [EndeavorCRM]    Script Date: 07-11-2025 09:07:13 ******/
...
USE [EndeavorCRM]
GO
/****** Object:  Table [dbo].[AgentMaster]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Deal]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoginFailure]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[LoginHistory]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Menu]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MenuRole]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Role]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UserMaster]    Script Date: 07-11-2025 09:07:13 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Deal] ([DealId], [TypeOfCoverage], [FirstName], [LastName], [NoOfApplicants], [FFM], [Career], [TypeOfWork], [MonthlyIncome], [DocNeeded], [SocialProvided], [CustomerLanguage], [CloseDate], [Notes], [AgentId], [IsActive], [CreatedBy], [CreatedOn], [UpdatedBy], [UpdatedOn], [IP]) VALUES (1, N'1', N'test', N'twww', 1, N'ii', 1, 1, 1, 1, 1, 1, CAST(N'2025-11-11T00:00:00.000' AS DateTime), N'w3453453', 2, 1, 1, CAST(N'2025-11-06T12:50:02.290' AS DateTime), NULL, NULL, N'::1')
GO
INSERT [dbo].[Deal] ([DealId], [TypeOfCoverage], [FirstName], [LastName], [NoOfApplicants], [FFM], [Career], [TypeOfWork], [MonthlyIncome], [DocNeeded], [SocialProvided], [CustomerLanguage], [CloseDate], [Notes], [AgentId], [IsActive], [CreatedBy], [CreatedOn], [UpdatedBy], [UpdatedOn], [IP]) VALUES (2, N'1', N'niyin_12', N'somi', 12, N'WWW', 1, 1, 33, 1, 1, 1, CAST(N'2025-11-11T00:00:00.000' AS DateTime), N'qwerwetrewrt', 2, 1, 1, CAST(N'2025-11-06T13:29:57.000' AS DateTime), 1, CAST(N'2025-11-06T21:33:48.773' AS DateTime), N'::1')
GO
...
GO
INSERT [dbo].[Menu] ([MenuId], [MenuName], [MenuNameId], [PageURL], [Icon], [ParentId], [DisplayOrder], [IsHaveChild], [IsActive], [IsShowtoAdmin]) VALUES (1, N'Dashboard', N'Dashboard', N'Index', N'test', 0, 1, 0, 1, 1)
GO
INSERT [dbo].[Menu] ([MenuId], [MenuName], [MenuNameId], [PageURL], [Icon], [ParentId], [DisplayOrder], [IsHaveChild], [IsActive], [IsShowtoAdmin]) VALUES (2, N'Master', N'Master', N'#', N'test', 0, 2, 1, 1, 1)
GO
INSERT [dbo].[Menu] ([MenuId], [MenuName], [MenuNameId], [PageURL], [Icon], [ParentId], [DisplayOrder], [IsHaveChild], [IsActive], [IsShowtoAdmin]) VALUES (3, N'Agent', N'Agent', N'Agent', N'test', 2, 0, 0, 1, 1)
GO
SET IDENTITY_INSERT [dbo].[MenuRole] ON 
GO
INSERT [dbo].[MenuRole] ([MenuRoleId], [MenuId], [RoleId]) VALUES (1, 1, 1)
GO
INSERT [dbo].[MenuRole] ([MenuRoleId], [MenuId], [RoleId]) VALUES (2, 2, 1)
GO
INSERT [dbo].[MenuRole] ([MenuRoleId], [MenuId], [RoleId]) VALUES (3, 3, 1)
GO
...
GO
INSERT [dbo].[UserMaster] ([UserMasterId], [Username], [UserPassword], [LastName], [FirstName], [ContactNumber], [RoleId], [IsFirstTimeLogin], [TwoStepAuth], [IsActive], [CreatedBy], [CreatedOn], [UpdatedBy], [UpdatedOn], [IP]) VALUES (3, N'nitin@gmail.com', N'3000~mY7k2LbIeRS5k9ZOqA8ecjdfM3Q+tOol~QWuxLAtUcwlk/2RgyCYpcj15NIoXogn3', N'Soni', N'Nitin', N'8009352740', 3, 1, 0, 1, 1, CAST(N'2025-11-06T10:47:34.817' AS DateTime), 3, CAST(N'2025-11-06T11:10:37.720' AS DateTime), N'::1')
GO
